...
<div class="min-h-[460px] flex items-center justify-center p-4">
  <div class="w-full max-w-sm bg-stone-900 text-stone-100 border border-stone-800 rounded-3xl p-6 shadow-xl relative text-center">
    ...
    <!-- Links Stack -->
    <div class="space-y-3">
      <a href="#" class="block bg-stone-950 border border-stone-800/60 py-3 px-4 rounded-2xl text-xs font-medium text-stone-200 hover:bg-stone-850 hover:-translate-y-0.5 active:translate-y-0 transition-all">
        🌐 Portfolio
      </a>
